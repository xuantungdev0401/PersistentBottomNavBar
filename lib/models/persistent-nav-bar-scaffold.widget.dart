...
class _TabSwitchingViewState extends State<_TabSwitchingView> with TickerProviderStateMixin {
  ...
  _initAniamtionControllers() {
    if (widget.screenTransitionAnimation!.animateTabTransition) {
      ...
      for (int i = 0; i < widget.tabCount!; ++i) {
        ...
        _animations[i] = Tween(begin: 0.0, end: 0.0).chain(CurveTween(curve: widget.screenTransitionAnimation!.curve)).animate(_animationControllers[i]!);
      }
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.screenTransitionAnimation!.animateTabTransition && _animationControllers.first!.duration != widget.screenTransitionAnimation!.duration ||
        _animationCurve != widget.screenTransitionAnimation!.curve) {
      _initAniamtionControllers();
    }
